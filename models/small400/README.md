...
---
# Rust EAGLE-3 — small400

Matched-update control: 14.47% lower paired fresh-Rust latency vs upstream in the control sessions.
...
Pool: 512 Rust. Optimizer updates: 400. Seed: 20260918. Batch 1 × accumulation 8; peak LR 1e-5; cosine horizon 400; gradient clip 0.5; training length 7. Checkpoint selected by separate Rust validation simulated acceptance length, not test timing. Target weights remain frozen.
...
`model.safetensors`: 799,457,128 bytes. SHA-256: `dc70b9f3f000c8ca7cc45431a1d7cb0d4fd9a68625d7ec117285ae05b60cf650`.
