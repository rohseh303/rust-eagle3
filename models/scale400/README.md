...
---
# Rust EAGLE-3 — scale400

Strongest Rust candidate tested: 15.63% lower paired fresh-Rust latency vs upstream (14.26–17.11% exploratory interval), and 1.76% vs the matched 512/400 control (0.40–2.84%).
...
Pool: 2,048 Rust. Optimizer updates: 400. Seed: 20260918. Batch 1 × accumulation 8; peak LR 1e-5; cosine horizon 400; gradient clip 0.5; training length 7. Checkpoint selected by separate Rust validation simulated acceptance length, not test timing. Target weights remain frozen.
...
`model.safetensors`: 799,457,128 bytes. SHA-256: `8084d09ddbd72c6874c81793534090e5a58ad69c7eefb22a8c5e7ddca4fd6b36`.
