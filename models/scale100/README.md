...
---
# Rust EAGLE-3 — scale100

Larger pool at 100 updates: only 800 distinct examples were seen; the direct gain over the 512/100 draft was inconclusive.
...
Pool: 2,048 Rust. Optimizer updates: 100. Seed: 20260918. Batch 1 × accumulation 8; peak LR 1e-5; cosine horizon 100; gradient clip 0.5; training length 7. Checkpoint selected by separate Rust validation simulated acceptance length, not test timing. Target weights remain frozen.
...
`model.safetensors`: 799,457,128 bytes. SHA-256: `4d976e42202c4a696e68ff777ebd1ddaa71d5adea926286c8e6ce37d6cced34e`.
